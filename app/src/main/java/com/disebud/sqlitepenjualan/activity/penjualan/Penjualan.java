...
public class Penjualan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn=(Button)findViewById(R.id.buttonPenjualan);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View arg0) {
                Intent inte = new Intent(Penjualan.this, BuatPenjualan.class);
                startActivity(inte);
            }
        } );
        pj = this;
    ...
    public void RefreshList() {
        ...
        ListView01 = (ListView)findViewById(R.id.listViewPenjualan);
        ...
        ListView01.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView arg0, View arg1, int arg2, long arg3) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Penjualan.this);
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        switch(item) {
                            case 0 :
                                ...
                                i.putExtra("idPenjualan" , selection);
                                startActivity(i);
                                break;
                            case 1 :
                                Intent in = new Intent(getApplicationContext(), UpdatePenjual.class);
                                in.putExtra("idPenjualan" , selection);
                                startActivity(in);
                                break;
                            case 2 :
                                SQLiteDatabase db = dbcenter.getWritableDatabase();
                                db.execSQL("delete from penjualan where id_penjualan = '" +selection+ "'");
                                Toast.makeText(getApplicationContext(), "Data Id Penjualan "+selection+" Berhasil Dihapus" ,
